...
<body>
    <div style="width: 100%; height: 100%">
            ...
            <ul>
                <li><a href="">HTML - CSS</a>
                    <ul id="submenu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/display-all">All Employees</a></li>
                        <li><a href="${pageContext.request.contextPath}/display/form.jsp">Form Insert</a></li>
                    </ul></li>
                <li><a href="">Java Script</a></li>
                <li><a href="">JQuery</a></li>
                <li><a href="">JSP</a></li>
        ...
        <div id="content1">
            <img src="${pageContext.request.contextPath}/image/images.jpg" alt="Kiem tra lai"> <br>
        ...
        <div id="content2">
            <ul>
                <li>
                    <h3>Ta me cua em</h3> <img src="${pageContext.request.contextPath}/image/gaixinh1.jpg"
                ...
                <li>
                    <h3>Ta bo cua em</h3> <img src="${pageContext.request.contextPath}/image/gaixinh2.jpg"
                ...
                <li>
                    <h3>Ta em gai cua em</h3> <img src="${pageContext.request.contextPath}/image/gaixinh3.jpg"
